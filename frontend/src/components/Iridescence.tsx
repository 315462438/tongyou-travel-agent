// Adapted from React Bits "Iridescence" (backgrounds) — https://reactbits.dev
// 非 Tailwind 项目：容器用可传入 className；用于协同行程板的柔和流光背景（Phase 35b）。
